...
-   **gwa.qc.bed** - Binary genotype matrix (compressed, encoded format). The reason why have this type of format is because the genotype matrix is very large, can have billions of entries, and have thousands of samples. So it is high dimensional. For that reason the file is compressed and it is encoded. It is a very large file
...
knitr::opts_knit$set(root.dir = normalizePath("../../"))
 ...
 #This creates a consisten path for all the files.
```
